...
from apps.core.domain.errors import BaseDomainError, ValidationDomainError
from apps.core.domain.messages.interfaces import IMessagesBus
from apps.users.domain.commands import send_registration_notification
from apps.users.models import User


class BaseRegistrationError(BaseDomainError):
